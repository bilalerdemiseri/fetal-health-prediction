...
Projeyi klonladıktan sonra eğitilmiş modeli test etmek için:
```bash
...
Not: Depo içerisinde model dosyaları yer almamaktadır. Programın derlenebilir ve çalıştırılabilir sürümü için "Releases" sekmesindeki app.exe dosyasını indirmeniz yeterlidir.